...
import com.paritytrading.philadelphia.ftx.FTX;
...
class Example {
    ...
    private static void usage() {
        System.err.println("Usage: ftx-fix-example <configuration-file>");
        System.exit(2);
    }
